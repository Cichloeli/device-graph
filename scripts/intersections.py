...
NUCLPATH = '../graphOmahaIndexed.mtx_23_NUCLEI'     # verticies contain in each node
JSONPATH = '../graphOmahaIndexed_23_circle.json'    # tree structure
VERTEXID = '../indexRevDict.json'                   # original vertex id

# output files
INTEPATH = '../data_files/intersections.json'       # intersection file
FORCPATH = '../data_files/graph_force.json'         # formatted intersection file

#Change these values if needed
CREATE_INTERFILE = True     #true or false
FILTER_SIZE = 10            #any non-negatvie int
...
def main():
    intersections = findIntersections(JSONPATH, NUCLPATH, VERTEXID, FILTER_SIZE)
    if CREATE_INTERFILE:
